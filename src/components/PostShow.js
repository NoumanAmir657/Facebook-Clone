    ...
    return (
        ...
        <div className='bg-white container shadow-2xl rounded-sm'>
            <div className='flex'>
                ...
                <h4 className='font-bold my-3'>{post.user} <span className='font-thin text-xs'><em>posted at {(new Date()).toUTCString()}</em></span></h4>
            </div>

            <div className='py-4 mx-3'>{post.postMsg}</div>
            <div className='py-4 mx-3'>{post.postMsg}</div>
            <div className='py-4 mx-3'>{post.postMsg}</div>
